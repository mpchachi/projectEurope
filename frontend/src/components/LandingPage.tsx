...
const CARDS = [
  ...
  { number: "08", title: "Filler Pressure", stat: "Work",  statLabel: "highest pressure topic", description: "Uh, um, you know — everyone has them. But where they cluster is the signal. Yours pile up around professional vocabulary. That's not a confidence problem. It's a domain gap. One targeted session on work vocabulary changes this metric permanently." },
...
function CardOverlay({ cardIndex }: { cardIndex: number }) {
  ...
  return (
    <div style={{ position: "fixed", ...pos, zIndex: 6, pointerEvents: "auto", opacity: visible ? 1 : 0, transition: "opacity 0.15s ease, top 0.2s ease, bottom 0.2s ease, left 0.2s ease, right 0.2s ease" }}>
    ...
    <section style={{ position: "relative", zIndex: 10, background: "#0a0a0a", minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", padding: "80px", gap: 80, flexWrap: "wrap" }}>
      <div style={{ flex: "1 1 400px", maxWidth: 560 }}>
        ...
        <p style={{ fontFamily: "var(--font-dm), system-ui, sans-serif", fontSize: 17, color: "rgba(255,255,255,0.4)", lineHeight: 1.7, fontWeight: 300, maxWidth: 440 }}>
          ...
          <PointerHighlight>you&rsquo;re becoming someone who speaks English</PointerHighlight>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 16, alignItems: "flex-start" }}>
        ...
        <button style={{ display: "inline-block", background: "transparent", color: "rgba(255,255,255,0.35)", fontFamily: "var(--font-dm), system-ui, sans-serif", fontWeight: 400, fontSize: 14, padding: "14px 36px", borderRadius: 999, border: "1px solid rgba(255,255,255,0.1)", cursor: "pointer", letterSpacing: "0.02em", whiteSpace: "nowrap" }}>
          Book lesson 13
        </button>
      </div>
    </section>
