    ...
    <div className="flex flex-col gap-4">
      <div className="flex items-end gap-6">
        <div>
          ...
          <div className="text-[#6F6F78] text-xs mt-1.5 font-medium">new words</div>
        </div>
        <div className="pb-1.5">
          <div className="text-4xl font-black text-[#121114] leading-none tracking-tight">{data.total_vocab}</div>
          <div className="text-[#6F6F78] text-xs mt-1 font-medium">total vocab</div>
        </div>
      </div>
